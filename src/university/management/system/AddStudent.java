...
//        setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
    ...
    public void actionPerformed(ActionEvent ae){
        if (ae.getSource()==submit){
            ...
            if (name.isEmpty()||fname.isEmpty()||rollno.isEmpty()||dob.isEmpty()||address.isEmpty()||phone.isEmpty()||x.isEmpty()||xii.isEmpty()||email.isEmpty()||aadhar.isEmpty()||course.isEmpty()||branch.isEmpty()){
                JOptionPane.showMessageDialog(null,"Please fill all the field","Error",JOptionPane.ERROR_MESSAGE);
            }
            else {
                try {
                    String query = "insert into Student values('" + name + "','" + fname + "','" + rollno + "','" + dob + "','" + address + "','" + phone + "','" + x + "','" + xii + "','" + email + "','" + aadhar + "','" + course + "','" + branch + "')";
